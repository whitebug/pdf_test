...
mixin _$HomeState {
 ...
 List<PdfFileEntity> get pdfList; List<PdfFileEntity> get pdfFilteredList; bool get isLoading; String? get readPdfError;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(pdfList),const DeepCollectionEquality().hash(pdfFilteredList),isLoading,readPdfError);

@override
String toString() {
  return 'HomeState(pdfList: $pdfList, pdfFilteredList: $pdfFilteredList, isLoading: $isLoading, readPdfError: $readPdfError)';
}
...
@useResult
$Res call({
 List<PdfFileEntity> pdfList, List<PdfFileEntity> pdfFilteredList, bool isLoading, String? readPdfError
});
...
/// Create a copy of HomeState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? pdfList = null,Object? pdfFilteredList = null,Object? isLoading = null,Object? readPdfError = freezed,}) {
...
class _HomeState implements HomeState {
  const _HomeState({final  List<PdfFileEntity> pdfList = const [], final  List<PdfFileEntity> pdfFilteredList = const [], this.isLoading = false, this.readPdfError}): _pdfList = pdfList,_pdfFilteredList = pdfFilteredList;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_pdfList),const DeepCollectionEquality().hash(_pdfFilteredList),isLoading,readPdfError);

@override
String toString() {
  return 'HomeState.state(pdfList: $pdfList, pdfFilteredList: $pdfFilteredList, isLoading: $isLoading, readPdfError: $readPdfError)';
}
...
/// Create a copy of HomeState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? pdfList = null,Object? pdfFilteredList = null,Object? isLoading = null,Object? readPdfError = freezed,}) {
